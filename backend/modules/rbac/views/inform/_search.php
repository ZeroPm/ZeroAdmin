...
/* @var $model common\models\searchs\Inform */
...
<div class="inform-search">
    ...
    <?= $form->field($model, 'content_id')->textInput(['class'=>'layui-input']) ?>

    <?= $form->field($model, 'title')->textInput(['class'=>'layui-input']) ?>

    <?= $form->field($model, 'star_time')->textInput(['class'=>'layui-input']) ?>

    <?= $form->field($model, 'inform_doc')->textInput(['class'=>'layui-input']) ?>
